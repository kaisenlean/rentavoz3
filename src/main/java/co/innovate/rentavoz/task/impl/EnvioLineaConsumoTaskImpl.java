 ...
 *
 */
@Service("envioLineaConsumoTask")
public class EnvioLineaConsumoTaskImpl  implements EnvioLineaConsumoTask,Serializable{
	...
	@Autowired
	private EnvioLineaConsumoService envioLineaConsumoService;
	...
	/* (non-Javadoc)
	 * @see co.innovate.rentavoz.task.EnvioLineaConsumoTask#enviarConsumosLineasSinVender()
	 */
	@Override
	public void enviarConsumosLineasSinVender() throws BaseException {
		logger.info("====== Iniciando Busqueda de Ejecuciones =========");
		DateFormat format= new SimpleDateFormat("HH:mm");
		CronActivity cronActivity= cronActivityService.findById(CronActivityParametro.ENVIO_LINEA_CONSUMO);
		...
		envioLineaConsumoService.enviarNotificacionLineasConsumoNoVendidas();
			logger.info("====== Fin de  =========");
		}
